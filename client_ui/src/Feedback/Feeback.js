...
const Home = () => {
  ...
  const postAPIHandler = async () => {
    const URL = "https://bt-task-uajs.onrender.com/";
    try {
      ...
      <form className="form-component" onSubmit={(e) => submitHandler(e)}>
        ...
        <p className="form-field">
          ...
          <input
            ...
            onChange={(e) => inputHandler("company", e)}
            required
          />
        </p>
        <div className="comment-container">
          ...
          <textarea
            ...
            placeholder="Please mention comment"
        ...
        {formStaus && (
          <p className="submit-status">Feedback from sucessfully submited</p>
        )}
      </form>
    </div>
  );
