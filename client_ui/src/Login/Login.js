...
const Login = () => {
  ...
  const testCredentials = () => {
    const result = {
      ...userState,
      email: "santhosh.pemmaka@gmail.com",
      password: "santhosh321",
    };
    setuserState((prev) => result);
  };

  const postAPIHandler = async () => {
    const URL = "https://bt-task-uajs.onrender.com/login";
    try {
  ...
  return (
    <div className="login-container">
      ...
      <div className="login-component">
        ...
        <button className="login-button-test" onClick={() => testCredentials()}>
